...
describe('Email', () => {
  ...
  test('should fail with invalid email', () => {
    ...
    expect(result.errors).toContain('form.validation.email.invalid');
  });

  test('should fail with undefined email', () => {
  ...
  test('should instance object with invalid email', () => {
